...
function setActiveColor(el){
    ...
    $(parentBlock).find(".character-color").removeClass("_active")
    $(el).addClass("_active")
    $(parentBlock).find(".tab-content").removeClass("_active-color")
    $(parentBlock).find(`.${tabId}`).addClass("_active-color")
}
